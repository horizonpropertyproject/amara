...
app.post('/send', function(req, res)
{
    ...
    if (err) {
		...
		//mailsubject  ="lodha amara Site Issue : Enquiry from website not sent";
	  //  mailbody ="Hi,please check sheth zuri site code.client details are not sent to your server";
		return;
	}
	...
	var client={
     Project_name:'Lodha Amara Megastar Thane',
	 name:req.body.name,
	...
	var query = con.query('INSERT INTO node_lead SET ?', client, function(err, result) {
    // Neat!
    });
	...
	res.send("Your Request is recorded. we will get back to you. ");
	});
